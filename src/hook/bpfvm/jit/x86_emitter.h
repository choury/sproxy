...
private:
    ...
    //   标量单精度算术（F3 前缀）：
    //     addss F3 0F 58   subss F3 0F 5C   mulss F3 0F 59   divss F3 0F 5E
    //   sqrtsd F2 0F 51 /r   sqrtss F3 0F 51 /r  (reg=dst rm=src)
    ...
    void sse_ucomiss(uint8_t xmm_a, uint8_t xmm_b);
};
